...
| UT_EXT_006 | PDFリンクの抽出 | リンクが存在 | extractPdfUrl()を実行 | dgrKokokuテーブル内の「入札」を含む行 | 正しいURLが取得される | High |
| UT_EXT_007 | 相対URLの変換 | 相対パスのリンク | extractPdfUrl()を実行 | href="/path/to/file.pdf" | 絶対URLに変換される | Medium |
| UT_EXT_008 | 様々な文書名称への対応 | 「入札公告」「入札の公告等」など | extractPdfUrl()を実行 | 「入札」を含む文書名称 | 正しいURLが取得される | High |
...
| TC_ID | テスト結果 | 備考 |
|-------|-----------|------|
| E2E_001 | ✓ 合格 | testpage.html, testpage1.html, testpage2.htmlで確認 |
| E2E_002 | ✓ 合格 | スプレッドシート形式で正しく整形 |
| E2E_003 | ✓ 合格 | 一覧ページでエラーメッセージ表示確認 |
| UT_EXT_001 | ✓ 合格 | 岐阜県、防衛省北関東防衛局で確認 |
| UT_EXT_002 | ✓ 合格 | 3種類の工事名称で確認 |
| UT_EXT_003 | ✓ 合格 | 防衛省案件で設計書番号確認 |
| UT_FMT_001 | ✓ 合格 | 防衛省北関東防衛局の分割確認 |
| UT_EXT_006 | ✓ 合格 | 全6パターンでPDF URL取得成功 |
| UT_EXT_008 | ✓ 合格 | 「入札の公告等」でも取得成功 |

### 9.2 確認済みブラウザ
- Chrome 131.0.6778.140（Windows/WSL2環境）
